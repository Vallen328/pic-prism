...
const { createPost, getAllPosts, getMyPosts, deletePost, searchPosts, addToFavourites, removeFromFavourites, getFavourites, getPostsByDateRange, updatePost } = require('../controllers/postController');
...
router.put("/post/edit/:id", verifyToken, updatePost);
