...
const Signup = () => {
  ...
  return (
    <div className="sm:mt-10 mt-20 min-h-screen flex items-center justify-center w-full">
        ...
        <form onSubmit = {handleSignup}>
          ...
          <div className="mb-4">
            ...
            <input 
              type="text" 
              name="email" id="email" 
              placeholder="vallen2608@gmail.com" 
              value = {email}
          ...
          <div className="mb-4">
            <label htmlFor="account type" className="block text-sm font-medium text-gray-700 mb-2">Select Your Account Type</label>
